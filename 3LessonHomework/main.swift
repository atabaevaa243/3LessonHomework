...
func calc() {
    ...
    func getMultiply (num1: Int, num2: Int) -> Int {
        ans = num1*num2
        return ans
    }
    func getDiv (num1: Int, num2: Int) -> Int {
        ans = num1/num2
        return ans
    }
    
    if (action == "+") {
        print(getAdd(num1: Int(num1)!, num2: Int(num2)!))
    }
     
    else if (action == "-") {
        print(getSub(num1: Int(num1)!, num2: Int(num2)!))
    }
    
    else if (action == "*") {
        print(getMultiply(num1: Int(num1)!, num2: Int(num2)!))
    }
    
    else if (action == "/") {
        print(getDiv(num1: Int(num1)!, num2: Int(num2)!))
    }
